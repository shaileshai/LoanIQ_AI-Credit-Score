      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {featuresList.map((feature) => (
            <Card key={feature.title} className="bg-background/40 border-primary/20 hover:border-accent/40 hover:bg-background/60 transition-all duration-300 transform hover:-translate-y-2 hover:scale-105 shadow-lg shadow-primary/5 hover:shadow-accent/20">
